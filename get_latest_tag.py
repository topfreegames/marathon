...
def main():
    url = "https://auth.docker.io/token?service=registry.docker.io&scope=repository:tfgco/marathon:pull,push"
    response = urllib.urlopen(url)
    token = json.loads(response.read())['token']

    url = "https://registry-1.docker.io/v2/tfgco/marathon/tags/list"
