...
/***/ function(module, exports, __webpack_require__) {
	...
	var _koaRoute = __webpack_require__(10);
	...
	var _healthcheck = __webpack_require__(15);
	
	var _healthcheck2 = _interopRequireDefault(_healthcheck);
	
	var _redis = __webpack_require__(16);
	
	var _postgresql = __webpack_require__(21);
	
	var _kafkaClient = __webpack_require__(24);
	
	var _kafkaProducer = __webpack_require__(26);
	              ...
	              case 2:
	                this.handlers.forEach(function (handler) {
	                  _this2.allowedMethods.forEach(function (methodName) {
	                    ...
	                    _this2.koaApp.use(method(handler.route, function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _redis = __webpack_require__(17);
	...
	var _redisInfo = __webpack_require__(19);
	
	var _redisInfo2 = _interopRequireDefault(_redisInfo);
	
	var _redlock = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	                ...
	                while (1) {
	                  switch (_context2.prev = _context2.next) {
	                    ...
	                    case 10:
	                      ...
	                      _fs2.default.readdirSync(basename).filter(function (file) {
	                        return file.indexOf('.') !== 0 && file !== basename && file.slice(-3) === '.js' && file !== 'index.js';
	                      }).forEach(function (file) {
	                        var modelPath = _path2.default.join(basename, file);
	                        logr.debug({ modelPath: modelPath }, 'Loading model...');
	                        var model = client.import(modelPath);
	                        logr.debug({ modelPath: modelPath }, 'Model loaded successfully.');
	                        db[model.name] = model;
	                      });
	...
	var basename = _path2.default.join(_path2.default.resolve(__dirname, '../models'));
	/* WEBPACK VAR INJECTION */}.call(exports, "/"))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _kafkaNode = __webpack_require__(25);
